...
class HostingPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hosting_plan" do
    assert_difference('HostingPlan.count') do
      post hosting_plans_url, 
           params: { hosting_plan: { memory: 512, name: "New Hosting Plan", price_per_hour: 0.05, price_per_month: 30, 
                                     slug: "new-hosting-plan", storage: 2048, transfer: 4096, vcpus: 2 } }
    end
  ...
  test "should update hosting_plan" do
    patch hosting_plan_url(@hosting_plan), 
          params: { hosting_plan: { memory: 1024, name: "Updated Hosting Plan", price_per_hour: 0.08, price_per_month: 50, 
                                    slug: "updated-hosting-plan", storage: 4096, transfer: 8192, vcpus: 4 } }
    assert_redirected_to hosting_plans_url
  end
