Rails.application.routes.draw do
  ...
  resources :users, except: %i[destroy show create]
  ...
  resources :users, only: %i[destroy show create]
  ...
  namespace :admin do
    ...
    resources :repositories
    resource :repository, path: 'repositories/:repository_id', only: %i[show destroy] do
