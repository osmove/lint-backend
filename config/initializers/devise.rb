...
Devise.setup do |config|
  ...
  config.mailer_sender = 'support@lint.to'
  ...
  # GitHub OAuth is configured per-environment in config/environments/*.
  # The callback URL must end with /users/auth/github/callback.
