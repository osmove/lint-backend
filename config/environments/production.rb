...
Devise.setup do |config|
  ...
  config.omniauth :github, 'dd33fc5fa2ff10074d2a', '5ea62b7c84855bff8a55aa46aa172f6738bd5b7c', scope: 'read:user, public_repo, read:org', :redirect_uri => 'https://lint.dev/users/auth/github/callback'
