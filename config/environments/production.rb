Rails.application.configure do
  ...
  Rails.application.routes.default_url_options[:host] = 'https://lint.dev'
...
Devise.setup do |config|
  ...
  config.omniauth :github, 'dd33fc5fa2ff10074d2a', '4b49afbb83ca036facbf81d316d7e368ac8175fb', scope: 'read:user, public_repo, read:org', :redirect_uri => 'https://lint.dev/users/auth/github/callback'
