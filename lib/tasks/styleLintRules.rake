namespace :styleLint do
  ...
  task generate: :environment do
    ...
    printWidth = Rule.create(name: "No invalid hex colors", slug: "color-no-invalid-hex", 
    ...
    noDuplicateNames = Rule.create(name: "Disallow duplicate font family names", 
    ...
    noMissingGenericFamilyKeyword = Rule.create(name: "Disallow missing generic families", 
    ...
    noUnspacedOperator = Rule.create(name: "Disallow an unspaced operator within calc functions", 
    ...
    noNonstandardDirection = Rule.create(name: "Disallow gradients non valid direction values", 
    ...
    unitNoUnknown = Rule.create(name: "Disallow unknown units", slug: "unit-no-unknown", 
    ...
    propertyNoUnknownOption = RuleOption.create( name: "Check Prefixed", slug: "checkPrefixed", value: "", 
    ...
    propertyNoUnknown = Rule.create(name: "Disallow \"!important\" within keyframe declarations", 
    ...
    declarationBlockNoDuplicatePropertiesChoiceOne = RuleOptionOption.create(
      rule_option: declarationBlockNoDuplicatePropertiesOption, value: "consecutive-duplicates" 
    )
    declarationBlockNoDuplicatePropertiesChoiceTwo = RuleOptionOption.create(
      rule_option: declarationBlockNoDuplicatePropertiesOption, value: "consecutive-duplicates-with-different-values" 
    )

    declarationBlockNoShorthandPropertyOverrides = Rule.create(
    ...
    blockNoEmpty = Rule.create(name: "Disallow empty blocks", slug: "block-no-empty", 
                               description: "Prevent empty block.", type: "Possible errors", linter: styleLint)

    selectorPseudoClassNoUnknown = Rule.create(name: "Disallow unknown pseudo-class selectors", 
    ...
    selectorPseudoElementNoUnknown = Rule.create(name: "Disallow unknown pseudo-element selectors", 
    ...
    selectorTypeNoUnknown = Rule.create(name: "Disallow unknown type selectors", slug: "selector-type-no-unknown", 
    ...
    mediaFeatureNameNoUnknown = Rule.create(name: "Disallow unknown media feature names", 
    ...
    atRuleNoUnknown = Rule.create(name: "Disallow unknown at-rules", slug: "at-rule-no-unknown", 
    ...
    commentNoEmpty = Rule.create(name: "Disallow empty comments", slug: "comment-no-empty", 
                                 description: "This rule ignores comments within selector and value lists.", type: "Possible errors", linter: styleLint)

    commentNoEmpty = Rule.create(name: "Disallow empty comments", slug: "comment-no-empty", 
                                 description: "This rule ignores comments within selector and value lists.", type: "Possible errors", linter: styleLint)

    noDescendingSpecificity = Rule.create(
    ...
    noDuplicateAtImportRules = Rule.create(name: "Disallow duplicate @import rules within a stylesheet", 
    ...
    noEmptySource = Rule.create(name: "Disallow empty sources", slug: "no-empty-source", 
                                description: "A source containing only whitespace is considered empty.", type: "Possible errors", linter: styleLint)

    noExtraSemicolons = Rule.create(name: "Disallow extra semicolons", slug: "no-extra-semicolons", 
                                    description: "This rule ignores semicolons after Less mixins.", fixable: true, type: "Possible errors", linter: styleLint)

    noInvalidDoubleSlashComments = Rule.create(name: "Disallow double-slash comments", 
