class HostingPlansController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @hosting_plan.save
        format.html { redirect_to hosting_plans_url, notice: 'Hosting plan was successfully created.' }
        format.json { render :show, status: :created, location: @hosting_plan }
      else
  ...
  def update
    respond_to do |format|
      if @hosting_plan.update(hosting_plan_params)
        format.html { redirect_to hosting_plans_url, notice: 'Hosting plan was successfully updated.' }
        format.json { render :show, status: :ok, location: @hosting_plan }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to hosting_plans_url, notice: 'Hosting plan was successfully destroyed.' }
