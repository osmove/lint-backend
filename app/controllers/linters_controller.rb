class LintersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @linter.save
        format.html { redirect_to @linter, notice: 'Linter was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @linter.update(linter_params)
        format.html { redirect_to @linter, notice: 'Linter was successfully updated.' }
  ...
  def destroy
    @linter.destroy
    respond_to do |format|
      format.html { redirect_to linters_url, notice: 'Linter was successfully destroyed.' }
