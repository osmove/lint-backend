module Admin
  class UsersController < Admin::BaseController
    ...
    def organizations_index
      @users = User.where(is_organization: true).order(created_at: :desc).page(params[:page]).per(20)
    end
  ...
  private
    ...
    def user_params
      params.expect(user: %i[username login slug first_name last_name email password
