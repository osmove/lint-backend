module Admin
  class CommitsController < Admin::BaseController
    ...
    def index_ssh
      ...
      Net::SSH.start('git.lint.to', 'root', password: 'b806d995ce24bfe8b30a8625fa') do |ssh|
        ...
        logs = logs.map do |log|
          ...
          l.shift if l[0].to_s.include? 'Merge:'
    ...
    def create
      ...
      respond_to do |format|
        if @commit.save
          ...
          format.json { render json: @commit.errors, status: :unprocessable_content }
        end
      end
    end
    ...
    def update
      ...
      respond_to do |format|
        if @commit.update(commit_params)
          format.html do
            redirect_to user_repository_commit_path(@user, @repository, @commit),
                        notice: 'Commit was successfully updated.'
          end
    ...
    def destroy
      ...
      respond_to do |format|
        format.html do
          redirect_to user_repository_path(@user, @repository), notice: 'Commit was successfully destroyed.'
        end
  ...
  private
    ...
    def commit_params
      params.expect(lint_commit: [:message,
