module Admin
  class RuleChecksController < Admin::BaseController
  ...
  private
    ...
    def rule_check_params
      params.expect(rule_check: %i[name passed commit_attempt_id policy_check_id file_name file_path rule_id repository_id linter_id user_id contributor_id push_id device_id
                                   file_name file_path
